...
<body>
    ...
    <section id="registro" class="registro">  
        ...
        <div id="caja_reg" class="caja_reg">
            ...
            <form action="createNewVet" method="POST" class="form_reg" enctype="multipart/form-data">                
                ...
                <label for="titulo">Al hacer click en "enviar datos" se aceptan los terminos y condiciones propuestos por este <a download="Términos" href="../archivos/Términos.pdf">documento</a> </label>
